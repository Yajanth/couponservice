pipeline {
    ...
    stages {
        ...
        stage('SonarQube Analysis') {
            ...
            steps {
                sh "mvn sonar:sonar -Dsonar.projectKey=Coupon_service_analysis -Dsonar.host.url=$SONAR_HOST_URL -Dsonar.login=$SONAR_AUTH_TOKEN -Dsonar.jacoco.reportPaths=target/jacoco.xml -Dsonar.tests=src/test/java/com/tus/coupon/unit/"
            }
            post {
                success {
