...
class CouponIntegrationTest {
    ...
    void createAndFetchCouponIntegrationTest() {
        Coupon coupon = new Coupon(null, "INTEGRATE3", new BigDecimal("15.00"), "2025-12-31");
        ...
        assertThat(created.getCode()).isEqualTo("INTEGRATE3");

        Coupon fetched = restTemplate.getForObject("/couponapi/coupons/INTEGRATE3", Coupon.class);
